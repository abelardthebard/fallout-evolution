 ...
 * Task_NewGameBirchSpeech_StartBirchPlatformFade
 * Task_NewGameBirchSpeech_StartBirchPlatformFade
 ...
 * Task_NewGameBirchSpeech_ReshowBirch
...
static void Task_NewGameBirchSpeech_WaitToShowRememberMenu(u8);
static void Task_NewGameBirchSpeech_ProcessRememberChoice(u8);
...
static void Task_NewGameBirchSpeech_ReshowBirch(u8);
...
static const u8 sText_IRemember[] = _("I remember");
...
static void Task_NewGameBirchSpeech_WaitForSpriteFadeInWelcome(u8 taskId)
{
    if (gTasks[taskId].tIsDoneFadingSprites)
    {
        ...
        else
        {
            ...
            StringExpandPlaceholders(gStringVar4, gText_MissNanny_Welcome);
...
static void Task_NewGameBirchSpeech_MainSpeech(u8 taskId)
{
    ...
    {
        StringExpandPlaceholders(gStringVar4, gText_MissNanny_MainSpeech);
        AddTextPrinterForMessage(TRUE);
        gTasks[taskId].func = Task_NewGameBirchSpeech_AskRemember;
    }
}

static void Task_NewGameBirchSpeech_AskRemember(u8 taskId)
{
    if (!RunTextPrintersAndIsPrinter0Active())
    {
        NewGameBirchSpeech_ClearWindow(0);
        StringExpandPlaceholders(gStringVar4, gText_MissNanny_RememberQuestion);
        AddTextPrinterForMessage(TRUE);
        gTasks[taskId].func = Task_NewGameBirchSpeech_WaitToShowRememberMenu;
    }
}

static void Task_NewGameBirchSpeech_WaitToShowRememberMenu(u8 taskId)
{
    if (!RunTextPrintersAndIsPrinter0Active())
    {
        DrawMainMenuWindowBorder(&sNewGameBirchSpeechTextWindows[3], 0xF3);
        FillWindowPixelBuffer(3, PIXEL_FILL(1));
        PrintMenuTable(3, ARRAY_COUNT(sMenuActions_Remember), sMenuActions_Remember);
        InitMenuInUpperLeftCornerNormal(3, ARRAY_COUNT(sMenuActions_Remember), 0);
        PutWindowTilemap(3);
        CopyWindowToVram(3, COPYWIN_FULL);
        gTasks[taskId].func = Task_NewGameBirchSpeech_ProcessRememberChoice;
    }
}

static void Task_NewGameBirchSpeech_ProcessRememberChoice(u8 taskId)
{
...
static void Task_NewGameBirchSpeech_ShowRemindLore(u8 taskId)
{
    StringExpandPlaceholders(gStringVar4, gText_MissNanny_RemindResponse);
    AddTextPrinterForMessage(TRUE);
    gTasks[taskId].func = Task_NewGameBirchSpeech_WaitRememberResponse;
}

static void Task_NewGameBirchSpeech_ShowRememberResponse(u8 taskId)
{
    StringExpandPlaceholders(gStringVar4, gText_MissNanny_RememberResponse);
    AddTextPrinterForMessage(TRUE);
    gTasks[taskId].func = Task_NewGameBirchSpeech_WaitRememberResponse;
}
...
static void Task_NewGameBirchSpeech_AndYouAre(u8 taskId)
{
    if (!RunTextPrintersAndIsPrinter0Active())
    {
        StringExpandPlaceholders(gStringVar4, gText_MissNanny_AndYouAre);
        AddTextPrinterForMessage(TRUE);
...
{
    NewGameBirchSpeech_ClearWindow(0);
    StringExpandPlaceholders(gStringVar4, gText_MissNanny_BoyOrGirl);
    AddTextPrinterForMessage(TRUE);
...
{
    NewGameBirchSpeech_ClearWindow(0);
    StringExpandPlaceholders(gStringVar4, gText_MissNanny_WhatsYourName);
    AddTextPrinterForMessage(TRUE);
...
{
    NewGameBirchSpeech_ClearWindow(0);
    StringExpandPlaceholders(gStringVar4, gText_MissNanny_SoItsPlayer);
    AddTextPrinterForMessage(TRUE);
...
static void Task_NewGameBirchSpeech_SlidePlatformAway2(u8 taskId)
{
    ...
    {
        gTasks[taskId].func = Task_NewGameBirchSpeech_ReshowBirch;
    }
}
...
static void Task_NewGameBirchSpeech_ReshowBirch(u8 taskId)
{
    ...
    if (gTasks[taskId].tIsDoneFadingSprites)
    {
        ...
        NewGameBirchSpeech_StartFadePlatformOut(taskId, 1);
        NewGameBirchSpeech_ClearWindow(0);
        StringExpandPlaceholders(gStringVar4, gText_MissNanny_YourePlayer);
        AddTextPrinterForMessage(TRUE);
...
static void Task_NewGameBirchSpeech_AreYouReady(u8 taskId)
{
    ...
    if (gTasks[taskId].tIsDoneFadingSprites)
    {
        ...
        NewGameBirchSpeech_StartFadePlatformOut(taskId, 1);
        NewGameBirchSpeech_ClearWindow(0);
        StringExpandPlaceholders(gStringVar4, gText_MissNanny_AreYouReady);
        AddTextPrinterForMessage(TRUE);

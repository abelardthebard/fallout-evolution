...
static const struct SpriteFrameImage sPicTable_ToddNormal[] = {
    overworld_ascending_frames(gObjectEventPic_ToddNormal, 2, 4),
};

static const struct SpriteFrameImage sPicTable_VaultMrsBauer[] = {
...
static const struct SpriteFrameImage sPicTable_VaultSecretary[] = {

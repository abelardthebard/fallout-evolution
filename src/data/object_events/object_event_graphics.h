...
const u16 gObjectEventPaletteEmotesNpc[] = INCBIN_U16("graphics/field_effects/pics/emotes.gbapal");
...
// Vault Chef
const u32 gObjectEventPic_VaultChef[] = INCBIN_U32("graphics/object_events/pics/people/vault_chef.4bpp");

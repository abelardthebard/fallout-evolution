...
// Apply PipBoy theme to all naming screen palettes (BG slots 0-11, all OBJ slots)
static void ApplyThemeToPalettes(void)
{
    PipBoy_ApplyThemeToPalettes(0, 12 * 16, OBJ_PLTT_OFFSET, 16 * 16);
}
...
{
    {TEXT_DYNAMIC_COLOR_4, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE},
    {TEXT_DYNAMIC_COLOR_5, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE},
    {TEXT_DYNAMIC_COLOR_6, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE}
};
